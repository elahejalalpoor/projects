 ...
 */
public final class Frame extends JFrame implements KeyListener, ActionListener, MouseListener,ItemListener,Runnable{
        ...
        salam.addItemListener(
            ...
            public void itemStateChanged(ItemEvent e) {
                ...
                if(salam.getSelectedIndex()==1)
                {
                    ...
                    {
                        Item i=(Item)it.next();
                        if(i.s.equals("smallHealthPotion"))
                        {
                            num++;
                            i.use(j);
...
//
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        { 
            ...
            { 
                Item i=(Item)it.next();
                if(i.s.equals("smallArrow") && enemynum>0) 
                {
                    enemynum--;
                    i.use(j);
                    it.remove();
